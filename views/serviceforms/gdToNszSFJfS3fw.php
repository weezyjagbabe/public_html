<?php
	$transactionDesc = "Bill Payment => theteller => PaySwitch Company Limited";											// Set the transaction description
	...
	if ( isset( $_POST['continue'] ) ) 
	{
		...
		if ( $validation -> checkRequired( $invoiceNumber ) ) 
		{
			// Echo the error and show the form again
			echo'<div class="alert alert-danger"><strong>Oh snap!</strong> Please enter an invoice number.</div>'
			?>
				<form class="validate" action="" method="post" role="form" id="form1">
					<div class="form-group">
						<label class="control-label">Enter invoice number</label>
						<input type='text' class="form-control" name='invoiceNumber' data-validate="required" value="<?php echo $invoiceNumber; ?>" required="" autocomplete="off" />
					</div>
		...
		{
			If( $tKey = $transactions -> addTransaction( $sKey, $invoiceNumber, $amountPaying, $transactionDesc, $transactionExtraData = $_POST ) )
			{
				...
				?>
					<form class="validate" action="" method="post" role="form" id="form1">
						<div class="form-group">
							...
							<input type='text' class="form-control" value="<?php echo $invoiceNumber; ?>" autocomplete="off" readonly/>
						</div>
	...
	else
	{
		?>
			<form class="validate" action="" method="post" role="form" id="form1">
				<div class="form-group">
					<label class="control-label">Enter invoice number</label>
					<input type='text' class="form-control" name='invoiceNumber' data-validate="required" placeholder='Enter invoice number' required="" autocomplete="off" />
				</div>
