<?php
	$transactionDesc = "Tithe => theteller => International Palace Church";											// Set the transaction description
    $tKey = null;
	...
	if ( isset( $_POST['continue'] ) ) 
	{
		...
		// Check if the $oName is empty
		if ( $validation -> checkRequired( $oName ) )
		{
			// Echo the error and show the form again
			echo'<div class="alert alert-danger"><strong>Oh snap!</strong> Please enter your name.</div>'
			?>
				<form class="validate" action="" method="post" role="form" id="form1">
                    ...
                    <div class="form-group">
                        <label class="control-label">Enter Payment Period</label>
                        <input type='text' class="form-control" name='paymentPeriod' data-validate="required" value="<?php echo $paymentPeriod; ?>" required="" autocomplete="off" />
                    </div>
		...
		{
			// Echo the error and show the form again
            echo'<div class="alert alert-danger"><strong>Oh snap!</strong> Please enter the amount you intend to pay.</div>'
            ?>
            <form class="validate" action="" method="post" role="form" id="form1">
                <div class="form-group">
                    <label class="control-label">Enter Name</label>
        ...
        elseif ( $validation -> checkRequired( $paymentPeriod  ) )
        {
            // Echo the error and show the form again
            echo'<div class="alert alert-danger"><strong>Oh snap!</strong> Please enter the period for your tithe return.</div>'
            ?>
            <form class="validate" action="" method="post" role="form" id="form1">
                <div class="form-group">
                    <label class="control-label">Enter Name</label>
				...
				?>
					<form class="validate" action="" method="post" role="form" id="form1">
                        ...
                        <div class="form-group">
                            ...
                            <input type='text' class="form-control" value="<?php echo $paymentPeriod; ?>" autocomplete="off" readonly/>
                        </div>
	...
	else
	{
		?>
			<form class="validate" action="" method="post" role="form" id="form1">
				<div class="form-group">
					<label class="control-label">Enter Name</label>
					<input type='text' class="form-control" name='oName' data-validate="required" placeholder='Enter your name' required="" autocomplete="off" />
				</div>

                <div class="form-group">
                    <label class="control-label">Enter Payment Period</label>
                    <input type='text' class="form-control" name='paymentPeriod' data-validate="required" placeholder='Enter tithe return period eg. December 2017' required="" autocomplete="off" />
                </div>
