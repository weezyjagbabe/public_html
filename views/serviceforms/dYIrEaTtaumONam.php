<?php
	$transactionDesc = "Offering => theteller => International Palace Church";											// Set the transaction description
	...
	if ( isset( $_POST['continue'] ) ) 
	{
		...
		if ( $validation -> checkRequired( $payerName ) )
		{
			...
			?>
				<form class="validate" action="" method="post" role="form" id="form1">
					<div class="form-group">
						...
						<input type='text' class="form-control" name='payerName' data-validate="required" value="<?php echo $payerName; ?>" required="" autocomplete="off" />
					</div>
		...
		{
			If( $tKey = $transactions -> addTransaction( $sKey, $payerName, $amountPaying, $transactionDesc, $transactionExtraData = $_POST ) )
			{
				...
				?>
					<form class="validate" action="" method="post" role="form" id="form1">
						<div class="form-group">
							...
							<input type='text' class="form-control" value="<?php echo $payerName; ?>" autocomplete="off" readonly/>
						</div>
	...
	else
	{
		?>
			<form class="validate" action="" method="post" role="form" id="form1">
				<div class="form-group">
					<label class="control-label">Enter Name</label>
					<input type='text' class="form-control" name='payerName' data-validate="required" placeholder='Enter your name' required="" autocomplete="off" />
				</div>
