			...
			<form class='validate' action='' method='post' role='form' id='form2'>
				<div class='panel-body'>
					<div class='form-group'>
						...
						<input type='text' class='form-control' name='phoneNumber' id="number" data-validate="number,maxlength[10],minlength[10]" placeholder='Enter your MTN number' required='' autocomplete='off' />
					</div>
					...
					<div class='form-group'>
						...
						<input type="hidden" name="mode" value="mtn" autocomplete='off' />
