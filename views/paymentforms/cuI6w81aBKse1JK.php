			...
			<form class='validate' action='' method='post' role='form' id='form2' autocomplete="off">
				<div class='panel-body'>
					<div class='form-group'>
						...
						<input type='text' class='form-control' name='cardNumber' id="number" placeholder='Enter your Mastercard number' required='' autocomplete='off' />
					</div>
					...
					<div class='row'>
						<div class='col-md-12'>
							<br />
							<div class='form-group'>
								<input type='checkbox' name='termsAgreement' class='checkbox' required autocomplete="foo" />
							...
							<div class='form-group'>
								...
								<input type="hidden" name="mode" value="master" autocomplete='off' />
