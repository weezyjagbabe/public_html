<?php
	$pageName = "Cancel Transaction";																	// Set the page name
	...
	<body class="page-body" data-url="">
		...
		<div class="page-container horizontal-menu">
			...
			<div class="main-content">
				...
				<em>Read the full details on your canceled transaction.</em>
				<hr />
				...
				<div class="invoice">
					<div class="row">
						...
						<div class="col-sm-8">
							...
							<div class="alert alert-info"><strong>Heads up!</strong> Transaction canceled successfully!</div>
