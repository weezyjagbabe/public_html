<?php
	$pageName = "Transaction Details";																	// Set the page name
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="invoice-right">
										...
										<a href="history" class="btn btn-success btn-icon icon-left hidden-print">Bank To History<i class="entypo-left"></i></a>
									</div>
								</div>
							</div>
						</div>
