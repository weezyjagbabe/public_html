<?php
	$pageName = "Transaction Receipt";																	// Set the page name
	...
	<body class="page-body" data-url="">
		...
		<div class="page-container horizontal-menu">
			...
			<div class="main-content">
				...
				<em>Congratutions: View the full details of your transaction.</em>
				<hr />
				...
				<div class="invoice">
					<div class="row">
						...
						<div class="col-sm-8">
							...
							<div class="alert alert-success"><strong>Well done!</strong> Transaction completed successfully!</div>
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="invoice-right">
										...
										<a href="services" class="btn btn-success btn-icon icon-left hidden-print">
